	...
	<div class="shopping-cart">
		<div class="px-4 px-lg-0">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th scope="col" class="border-0 bg-light">
												<div class="p-2 px-3 text-uppercase">Đơn Giá</div>
											</th>
											<th scope="col" class="border-0 bg-light">
			...
			<tr>
				...
				<td><img src="${entry.value.product.pImage }" width="100" /></td>
			</tr>
		</c:forEach>-->
								 ...
								 <tbody>
										<c:forEach items="${sessionScope.cart}" var="map">
											<tr>
												...
												<th scope="row">
													<div class="p-2">
														<img src="${map.value.product.pImage}" alt="" width="70"
															class="img-fluid rounded shadow-sm">
														<div class="ml-3 d-inline-block align-middle">
															<h5 class="mb-0">
																<a href="#" class="text-dark d-inline-block">${map.value.product.pName}</a>
															</h5>
												...
												<td class="align-middle"><strong>${map.value.product.pPrice}</strong></td>
												
												<td class="align-middle"><a href="/Shopee/member/cart-quantityincdec?action=sub&pId=${map.value.product.pId}"><button
												...
												<td class="align-middle"><strong>${map.value.product.pPrice * map.value.count}</strong></td>
												
												<td class="align-middle"><a href="/Shopee/member/cart-remove?pId=${map.value.product.pId}" class="text-dark">
														<button
