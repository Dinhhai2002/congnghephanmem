					...
					<div class="col l-12 lo-12 m-12 c-12">
						...
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									<tr style="margin: 8px 0;">
										...
										<td><img
											src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnAMhxybe3Dj4npaJLC5bmTXxLah9b-owEoQ&usqp=CAU">
										</td>
										<td>90</td>
							...
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6">
										<a href="#" class="table-title-header"> Quản lý sản phẩm
										</a> <a href="#" class="table-title-header" data-toggle="modal">
											<span>Đơn hàng</span>
										</a> <a href="#" class="table-title-header" data-toggle="modal">
											<span>Chỉnh sửa thông tin shop</span>
										</a>
									</div>
									...
									<c:forEach items="${listP}" var="o">
										<tr style="margin: 8px 0;">
											...
											<td><a href="#editEmployeeModal" class="edit"
												data-toggle="modal"><i class='bx bxs-pencil'></i></a> <a
												href="#deleteEmployeeModal" class="delete"
												data-toggle="modal"><i class='bx bx-trash'></i></a></td>
										</tr>
										<tr>
						...
						<div class="modal-body">
							...
							<div class="form-group form-group-col">
								...
								<img class="img-responsive" width="100px"
									src="./assets/img/avatar_user.jpeg" alt=""> <label
									style="margin-top: 10px">Ảnh đại diện</label> <input
									type="file" name="icon" value="${category.icon }" />
							</div>
