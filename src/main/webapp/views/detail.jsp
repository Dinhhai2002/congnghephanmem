                    ...
                    <div class="col-sm-3">
                        <nav class="category">
                            <h3 class="category__heading">                             
                                <a class="category__heading-icon" href=""><i class='bx bx-list-ul' ></i></a>
                                Danh mục</h3>
                            <ul class="category-list">
                                <!-- category-item-active -->
                                <li class="category-item ">
                                    <a href="#" class="category-item_link">Trang điểm mặt</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item_link">Trang điểm môi</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item_link">Trang điểm mắt</a>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="row">
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <img class="gallery-wrap-img"src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnAMhxybe3Dj4npaJLC5bmTXxLah9b-owEoQ&usqp=CAU" alt="">
                                            ...
                                            <div class="col-sm-5">
                                                <dl class="param param-inline">
                                                    ...
                                                    <div class="model_quantity_number">
                                                        <a class="model_quantity_number_add"href="#"><i class='bx bx-plus'></i></a>
                                                        <p class="model_quantity_number_quan">2</p>
                                                        <a class="model_quantity_number_remove"href="#"><i class='bx bx-minus' ></i></a>
                                                      </div>
                                                </dl>  <!-- item-property .// -->
                                            </div> <!-- col.// -->
